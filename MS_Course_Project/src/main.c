...
int main(void)
{
  ...
  while (1) {
    ...
    // SHTC3 End of flowchart
    if (SH_CALLBACK & get_scheduled_events())
      {
        remove_scheduled_event(SH_CALLBACK);
        scheduled_shtc3_read_cb();

      }
    // callback to start temp i2c
//    if (TEMP_START_CB & get_scheduled_events())
//      {
//        remove_scheduled_event(TEMP_START_CB);
//        scheduled_si7021_read_cb();
//
//      }
//
//    // temp measure
//    if (TEMP_MEASURE_CB & get_scheduled_events())
//          {
//            remove_scheduled_event(TEMP_MEASURE_CB);
//            scheduled_si7021_read_cb();
//
//          }
