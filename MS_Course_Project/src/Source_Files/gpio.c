...
void gpio_open(void){
  ...
  GPIO_PinModeSet(SHTC3_SENSOR_EN_PORT, SHTC3_SENSOR_EN_PIN, gpioModePushPull, SHTC3_SENSOR_EN_DEFAULT);
  GPIO_DriveStrengthSet(SHTC3_SENSOR_EN_PORT, SH_DRIVESTRENGTH);
  GPIO_PinModeSet(SHTC3_SCL_PORT, SHTC3_SCL_PIN, gpioModeWiredAnd, SHTC3_SENSOR_EN_DEFAULT);
  GPIO_PinModeSet(SHTC3_SDA_PORT, SHTC3_SDA_PIN, gpioModeWiredAnd, SHTC3_SENSOR_EN_DEFAULT);
