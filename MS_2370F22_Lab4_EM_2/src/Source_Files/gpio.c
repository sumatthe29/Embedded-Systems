...
void gpio_open(void){
  ...
  // SENSOR GPIO SETUP
  GPIO_DriveStrengthSet(SI7021_SENSOR_EN_PORT, StrengthWeakAlternateWeak);
  GPIO_PinModeSet(SI7021_SENSOR_EN_PORT, SI7021_SENSOR_EN_PIN, SI7021_GPIOMODE_SENSOR, SI7021_SENSOR_DEFAULT);

  // SCL PinModeSet
  GPIO_PinModeSet(SI7021_SCL_PORT,SI7021_SCL_PIN,SI7021_GPIOMODE_PIN,SI7021_SCL_DEFAULT);
  // SDA PinModeSet
  GPIO_PinModeSet(SI7021_SDA_PORT,SI7021_SDA_PIN,SI7021_GPIOMODE_PIN,SI7021_SDA_DEFAULT);
