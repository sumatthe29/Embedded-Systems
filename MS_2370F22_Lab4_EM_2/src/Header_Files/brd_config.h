...
#define StrengthWeakAlternateWeak gpioDriveStrengthWeakAlternateWeak
#define SI7021_GPIOMODE_SENSOR    gpioModePushPull
#define SI7021_GPIOMODE_PIN       gpioModeWiredAnd
#define SI7021_SCL_DEFAULT        true //Check value
